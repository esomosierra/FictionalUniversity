...
<body class="<?php body_class(); ?>">
    <header class="site-header">
        ...
        <div class="site-header__menu group">
            ...
            ?>
            <ul>
                <li <?php if (is_page('about-us') || wp_get_post_parent_id(0) == 16) echo 'class="current-menu-item"' ?>><a href="<?php echo esc_url(site_url('/about-us')) ?>">About Us</a></li>
            ...
            <div class="site-header__util">
                <?php if (is_user_logged_in()) { # If user is currently logged in ?>
